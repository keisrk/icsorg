...
(* OASIS_START *)
(* DO NOT EDIT (digest: debe82a44125faf5239c63dd960d2296) *)
(*
...
let setup_t =
  {
            ...
            [
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "handle.ml"})
            ];
     ...
     oasis_version = "0.4.7";
     oasis_digest = Some "\005\0038\172\146\169h\183\185&\003}\019(\003\149";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
