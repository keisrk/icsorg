...
(* OASIS_START *)
(* DO NOT EDIT (digest: d50ecef5c5de8796367293630e6bc23d) *)
(*
...
let setup_t =
  {
            ...
            [
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "trial.ml"})
            ];
     ...
     oasis_version = "0.4.7";
     oasis_digest = Some "\243\131\r\023Y\149GW\015g\213-B\249l\201";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
